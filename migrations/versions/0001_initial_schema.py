...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "global_role", sa.String(length=20), server_default="player", nullable=False
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "is_eliminated", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    # 4. Team Members (Règle: Un joueur dans au plus 1 équipe par tournoi)
    op.create_table(
        "team_members",
        sa.Column(
            "id",
        ...
        sa.UniqueConstraint(
            "tournament_id", "user_id", name="uq_player_per_tournament"
        ),
